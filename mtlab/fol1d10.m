...
%parameters:
global d D Dm Rtot1 Rtot2 kon1 koff1 kon2 koff2 kdeg1 kdeg2 kg1 kg2...
...
for i= 3: M,
    ...
    [U(:,i),W(:,i),V(:,i),Y(:,i),R1(:,i),R2(:,i)]=ifrk2(u,w,v,y,r1,r2, dt);
    u=U(:,i);
    v=V(:,i);
    w=W(:,i);
    y=Y(:,i);
...
function [un,wn,vn,yn,r1n,r2n]=ifrk2(u,w,v,y,r1,r2,dt)
global Dm;
